...
const APP_ROUTES = {
  ...
  LOGIN: '/login.html',
  SIGNUP: '/signup.html',
  STUDENT_DASHBOARD: '/pages/student/student-dashboard.html',
  STUDENT_ATTENDANCE: '/pages/student/student-attendance.html',
  TEACHER_DASHBOARD: '/pages/teacher/teacher-dashboard.html',
  TEACHER_MARK_ATTENDANCE: '/pages/teacher/teacher-mark-attendance.html',
